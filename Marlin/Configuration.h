...
#define STRING_CONFIG_H_AUTHOR "@skruppy" // Original author or contributor.
//#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no quotes)
#define SOURCE_CODE_URL "github.com/Skruppy/Marlin"
...
#define CUSTOM_MACHINE_NAME "clay"
//#define CONFIGURABLE_MACHINE_NAME // Add G-code M550 to set/report the machine name

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "3e150298-0b9c-4998-9fc9-6fa52a8a4dea"
...
#define DELTA
  ...
  #define PRINTABLE_RADIUS       115.0    // (mm)
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 186.0
  #define DELTA_EFFECTOR_OFFSET    31.0
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 415 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -16.13 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define Z_PROBE_FEEDRATE_SLOW (12*60) // (mm/min)
...
#define X_BED_SIZE (2 * PRINTABLE_RADIUS)
 ...
 */
// Restore: Enable if it was enabled before, keep disabled if it was disabled before
...
#define HOMING_FEEDRATE_MM_M { (48*60), (48*60), (48*60) }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, Y_MIN_POS+30, 150 }
