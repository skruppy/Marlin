...
#define BACKLASH_COMPENSATION
  ...
  //#define BACKLASH_GCODE
    ...
    #define MEASURE_BACKLASH_WHEN_PROBING
      ...
      #define BACKLASH_MEASUREMENT_RESOLUTION  0.0125 // (mm)
...
//#define DISABLE_REDUCED_ACCURACY_WARNING
  ...
  #define MANUAL_FEEDRATE { 25*60, 25*60, 25*60, 1*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
  #define FINE_MANUAL_MOVE 0.0125    // (mm) Smallest manual move (< 0.1mm) applying to Z on most machines
  #if IS_ULTIPANEL
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.5 }    // (mm) Compression length per 1mm/s extruder speed, per extruder. Override with 'M900 T<tool> K<mm>'.
  #else
    #define ADVANCE_K 0.5        // (mm) Compression length for all extruders. Override with 'M900 K<mm>'.
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     13  // (mm/s^2) Lower acceleration may allow a faster feedrate.
